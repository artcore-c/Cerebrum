...
See [Cerebrum Backend API](../../README.md#api-endpoints) for endpoint specifications.
...
```
3. Update model configuration in `vps_server/main.py`(see [model-configuration](../../README.md#model-configuration))
