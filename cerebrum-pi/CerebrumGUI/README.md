...
```
3. Update model configuration in `vps_server/main.py`
   (see: [model-configuration](../../cerebrum-backend#model-paths-important))
...
See: [Cerebrum](/#contributing) README.md for contribution guidelines.
